class ProveedoresController < BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @proveedore.save
        format.html { redirect_to @proveedore, notice: 'Proveedor ha sido creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @proveedore.update(proveedore_params)
        format.html { redirect_to @proveedore, notice: 'Proveedor ha sido modificado exitosamente.' }
  ...
  def destroy
    @proveedore.destroy
    respond_to do |format|
      format.html { redirect_to proveedores_url, notice: 'Proveedor ha sido eliminado exitosamente.' }
  ...
  private
    ...
    def proveedore_params
      params.require(:proveedore).permit(:identificacion, :nombre, :idCiudad, :idDpto, :dirreccion, :correo, :telefonos, :idTipoProv, :idEstadoProv, :idCategoriaProv, :comentario)
    end
end
